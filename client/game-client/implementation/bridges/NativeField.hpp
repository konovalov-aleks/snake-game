...
private:
    ...
    const jmethodID jconstructor { ::djinni::jniGetMethodID(clazz.get(), "<init>", "(Lru/tensor/generated/Walls;Lru/tensor/generated/VectorModel;Ljava/util/ArrayList;Lru/tensor/generated/SnakeModel;)V") };
